...
@testitem "floating point precision - catastrophic cancellation" begin
    ...
    lower = 1e15
    upper = 1e15 + 1.0
    grid = DiscretizedGrid{1}(10; lower_bound=(lower,), upper_bound=(upper,))
    ...
    lower = 1e12
    upper = 1e12 + 1e6
    grid2 = DiscretizedGrid{1}(15; lower_bound=(lower,), upper_bound=(upper,))
...
@testitem "floating point precision - round-trip consistency stress test" begin
    ...
    test_grids = [
        ...
        DiscretizedGrid{1}(20),
        # Very small range
        DiscretizedGrid{1}(15; lower_bound=(1e-10,), upper_bound=(1e-9,)),
        # Very large range  
        DiscretizedGrid{1}(12; lower_bound=(1e10,), upper_bound=(1e11,)),
        # Negative range
        DiscretizedGrid{1}(18; lower_bound=(-1e5,), upper_bound=(-1e4,)),
        # Asymmetric around zero
        DiscretizedGrid{1}(16; lower_bound=(-1e-6,), upper_bound=(1e-5,)),
    ]
...
@testitem "floating point precision - extreme coordinate ranges" begin
    ...
    for (lower, upper, R) in test_cases
        grid = DiscretizedGrid{1}(R; lower_bound=(lower,), upper_bound=(upper,))
...
@testitem "floating point precision - step size edge cases" begin
    ...
    grid1 = DiscretizedGrid{1}(10; lower_bound=(0.0,), upper_bound=(1.0 / 3.0,))
    ...
    sqrt2 = sqrt(2.0)
    grid2 = DiscretizedGrid{1}(8; lower_bound=(0.0,), upper_bound=(sqrt2,))
    ...
    grid3 = DiscretizedGrid{1}(4; lower_bound=(0.0,), upper_bound=(eps(Float64) * 100,))
...
@testitem "floating point precision - includeendpoint behavior edge cases" begin
    ...
    grid_without = DiscretizedGrid{1}(R; includeendpoint=false)
    grid_with = DiscretizedGrid{1}(R; includeendpoint=true)
...
@testitem "floating point precision - mixed precision operations" begin
    ...
    grid = DiscretizedGrid{1}(12; lower_bound=(0.1,), upper_bound=(0.9,))
